<section class="mb-2">
    <h5 class="m-0 font-weight-bold text-primary"><i class="fas fa-th-list"></i> <strong>Ticket Summary</strong></h5>
</section>
            ...
            <table data-classes="table table-bordered table-sm table-hover table-striped" id="dataTable" data-toolbar="#toolbar" data-export-footer="true" data-search="true" data-show-toggle="true" data-show-fullscreen="true" data-show-columns="true" data-show-columns-toggle-all="true" data-show-export="true" data-minimum-count-columns="2" data-show-pagination-switch="true" data-pagination="true" data-id-field="id" data-page-size="25" data-page-list="[25, 50, 100, all]" data-sort-name="TranID" data-sort-order="desc">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th data-field="SRTotal" data-halign="center" class="text-nowrap text-center" data-formatter="badgeValFormat">Total(SR)</th>
                        <th data-field="WCTotal" class="text-nowrap text-center" data-formatter="badgeValFormat">Total(WC)</th>
                        <th data-field="Totals" class="text-nowrap text-center" data-formatter="badgeValFormat">Totals</th>
                    </tr>
                </thead>
            </table>
        </div>
...
<script>
    ...
    function initData() {
        ...
        $.ajax({
            type: 'POST',
            url: "<?= site_url('ReportController/FetchAllTicketSummary') ?>",
            data: $.param(objs),
            dataType: 'JSON',
            beforeSend: function() {
                blockUI('Processing...');
