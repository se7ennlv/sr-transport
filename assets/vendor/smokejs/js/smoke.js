...
(function($) {
  ...
  */
  $.fn.smkFullscreen = function() {
    ...
    var btnFullscreen = '<a class="btn smk-fullscreen" href="#"><span class="fas fa-compress" aria-hidden="true"></span></a>';
    ...
    var changeFullscreen = function(){
      $('.smk-fullscreen').children('.fas').toggleClass('fa-compress').toggleClass('fa-compress-arrows-alt');
    };
